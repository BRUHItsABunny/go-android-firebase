...
var file_mcs_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x4a, 0x0a, 0x16, 0x6f, 0x72, 0x67, 0x2e,
	0x6d, 0x69, 0x63, 0x72, 0x6f, 0x67, 0x2e, 0x67, 0x6d, 0x73, 0x2e, 0x67, 0x63, 0x6d, 0x2e, 0x6d,
	0x63, 0x73, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x42,
...
var file_mcs_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_mcs_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_mcs_proto_goTypes = []interface{}{
	(LoginRequest_AuthService)(0), // 0: LoginRequest.AuthService
	(IqStanza_IqType)(0),          // 1: IqStanza.IqType
	(*HeartbeatPing)(nil),         // 2: HeartbeatPing
	(*HeartbeatAck)(nil),          // 3: HeartbeatAck
	(*ErrorInfo)(nil),             // 4: ErrorInfo
	(*Setting)(nil),               // 5: Setting
	(*HeartbeatStat)(nil),         // 6: HeartbeatStat
	(*HeartbeatConfig)(nil),       // 7: HeartbeatConfig
	(*LoginRequest)(nil),          // 8: LoginRequest
	(*LoginResponse)(nil),         // 9: LoginResponse
	(*StreamErrorStanza)(nil),     // 10: StreamErrorStanza
	(*Close)(nil),                 // 11: Close
	(*Extension)(nil),             // 12: Extension
	(*IqStanza)(nil),              // 13: IqStanza
	(*AppData)(nil),               // 14: AppData
	(*DataMessageStanza)(nil),     // 15: DataMessageStanza
	(*StreamAck)(nil),             // 16: StreamAck
	(*SelectiveAck)(nil),          // 17: SelectiveAck
}
var file_mcs_proto_depIdxs = []int32{
	12, // 0: ErrorInfo.extension:type_name -> Extension
	5,  // 1: LoginRequest.setting:type_name -> Setting
	6,  // 2: LoginRequest.heartbeat_stat:type_name -> HeartbeatStat
	0,  // 3: LoginRequest.auth_service:type_name -> LoginRequest.AuthService
	4,  // 4: LoginResponse.error:type_name -> ErrorInfo
	5,  // 5: LoginResponse.setting:type_name -> Setting
	7,  // 6: LoginResponse.heartbeat_config:type_name -> HeartbeatConfig
	1,  // 7: IqStanza.type:type_name -> IqStanza.IqType
	4,  // 8: IqStanza.error:type_name -> ErrorInfo
	12, // 9: IqStanza.extension:type_name -> Extension
	14, // 10: DataMessageStanza.app_data:type_name -> AppData
